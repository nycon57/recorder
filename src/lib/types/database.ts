    ...
    Tables: {
      ...
      org_wiki_pages: {
        Row: {
          ...
          updated_at: string;
          /**
           * Vector embedding of topic + content excerpt, generated by
           * the compile_wiki worker (TRIB-31). Used by the fusion
           * engine in /api/extension/query (TRIB-35) for top-N
           * similarity matching. Model: gemini-embedding-001 (1536 dims).
