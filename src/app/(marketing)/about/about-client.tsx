...
const MILESTONES = [
  {
    ...
    title: 'The Spark',
    description:
      'Tribora was born from a simple idea: make tacit knowledge capture effortless and illuminated.',
  },
  {
    year: '2023',
    quarter: 'Q4',
    title: 'Beta Launch',
    description:
      'Released to first 100 design partners, gathering invaluable feedback to shape the product.',
  },
  {
    year: '2024',
    quarter: 'Q2',
    title: 'Public Launch',
    description:
      'Opened to the public with full AI-powered features: transcription, docify, and semantic search.',
  },
  {
    year: '2024',
    quarter: 'Q4',
    ...
    description:
      'Launched cross-recording concept linking - the foundation of our compounding knowledge MOAT.',
  },
];
...
export default function AboutPage() {
  return useAboutPageImplementation();
}

function useAboutPageImplementation() {
  return (
    <div className="flex flex-col">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          {/* Aurora orbs */}
          <div
            className="absolute top-[-10%] right-[15%] size-[500px] rounded-full
        ...
        <div className="relative z-10 container px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          ...
          >
            ...
            >
              ...
              <span className="bg-[length:200%_auto] animate-gradient-x text-primary">
                tribe
              </span>
            ...
            >
              <span className="font-medium text-foreground">Tribora</span> ={' '}
              <span className="text-accent">Tribe</span> +{' '}
              <span className="text-secondary">Aurora</span>. We illuminate your
              team's collective knowledge, making the invisible visible.
            </motion.p>
            ...
            >
              <span className="text-sm text-muted-foreground">
                The Knowledge Intelligence Layer
              </span>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div
            className="absolute top-[10%] left-[5%] size-[400px] rounded-full
              bg-[radial-gradient(ellipse_at_center,rgba(0,223,130,0.06)_0%,transparent_70%)]
              blur-[100px]"
          />
          <div
            className="absolute bottom-[20%] right-[10%] size-[350px] rounded-full
        ...
        <div className="container px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              The <span className=" text-primary">mythology</span> behind
              Tribora
            </motion.h2>
            ...
            >
              ...
              <motion.div variants={fadeInUp}>
                ...
                <p className="text-lg text-muted-foreground font-light leading-relaxed">
                  At Tribora, we believe that valuable knowledge shouldn't be
                  locked away in people's heads or buried in hours of video
                  content. We're building the future of knowledge management-
                  where capturing expertise is as simple as recording your
                  screen, and finding answers is as easy as asking a question.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp}>
                ...
                <div className="grid sm:grid-cols-3 gap-6">
                  {[
                    {
                      label: 'NOT a Loom replacement',
                      detail: 'We capture expertise, not messages',
                    },
                    {
                      label: 'NOT a meeting tool',
                      detail: 'We understand workflows, not just audio',
                    },
                    {
                      label: 'NOT storage',
                      detail: "We're the intelligence layer above storage",
                    },
                  ].map((item) => (
                    <div
                      key={item.label}
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div
            className="absolute top-[30%] right-[5%] size-[500px] rounded-full
              bg-[radial-gradient(ellipse_at_center,rgba(0,223,130,0.06)_0%,transparent_70%)]
              blur-[100px] animate-float"
            ...
            <div className="space-y-12">
              {MILESTONES.map((milestone, index) => (
                ...
                >
                  {/* Timeline dot */}
                  <div
                    className="absolute left-4 md:left-1/2 -ml-2 size-4 rounded-full
                  ...
                  >
                    ...
                    >
                      ...
                      <h3 className="font-outfit text-lg font-medium mb-2">
                        {milestone.title}
                      </h3>
                      <p className="text-sm text-muted-foreground">
        ...
        <div className="container px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <motion.h2
              ...
              className="font-outfit text-3xl sm:text-4xl lg:text-5xl font-light leading-tight tracking-tight mb-6"
            >
              The <span className=" text-primary">builders</span> behind Tribora
            </motion.h2>
            ...
            {TEAM.map((member) => (
              ...
              >
                ...
                <div className="relative mb-6 mx-auto">
                  <div
                    className="size-32 mx-auto rounded-2xl
                ...
                {/* Info */}
                <h3 className="font-outfit text-xl font-medium mb-1">
                  {member.name}
                </h3>
