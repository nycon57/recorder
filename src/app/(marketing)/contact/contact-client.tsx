...
export default function ContactPage() {
  return useContactPageImplementation();
}

function useContactPageImplementation() {
    ...
    <div className="flex flex-col">
      ...
      <section className="relative pt-24 pb-16 sm:pt-32 sm:pb-20 lg:pt-40 lg:pb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          {/* Flowing aurora orbs */}
          <div
            className="absolute top-[5%] right-[10%] size-[600px] rounded-full
              bg-[radial-gradient(ellipse_at_center,rgba(0,223,130,0.1)_0%,transparent_70%)]
              blur-[100px] animate-float"
            style={{ animationDelay: '0s' }}
          />
          <div
            className="absolute top-[40%] left-[5%] size-[500px] rounded-full
        ...
        <div className="container px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              ...
              enterprise solutions, we&rsquo;re here to help illuminate your
              path forward.
            </motion.p>
          </motion.div>
        </div>
            ...
            {CONTACT_METHODS.map((method, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div
                    className={cn(
                      'size-14 rounded-xl mb-5 flex items-center justify-center',
              ...
              >
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground mb-5">
                    Explore our resources for instant help with common
                    questions.
                  </p>
...
function SuccessState({ onReset }: { onReset: () => void }) {
  return (
    ...
    >
      {/* Success Icon */}
      <motion.div
        className="size-20 mx-auto mb-6 rounded-full
