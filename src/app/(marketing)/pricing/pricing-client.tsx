...
const PRICING_TIERS: PricingTier[] = [
  {
    name: 'Starter',
    description:
      'Perfect for individuals exploring AI-powered knowledge capture',
    monthlyPrice: 0,
    annualPrice: 0,
    features: [
  ...
  },
  {
    name: 'Enterprise',
    description:
      'Advanced features for large organizations with security needs',
    monthlyPrice: 99,
    annualPrice: 990,
    features: [
      'Everything in Pro',
...
const COMPARISON_DATA: ComparisonRow[] = [
  ...
  {
    feature: 'Visual/Screen Recording',
    sharepoint: false,
    google: false,
    manual: false,
    tribora: true,
    triboraHighlight: true,
  },
  {
  ...
  {
    feature: 'Publish Back to Source',
    sharepoint: false,
    google: false,
    manual: false,
    tribora: true,
...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer:
      "The free plan includes 5 recordings per month, AI-powered transcription, 1GB of storage, and basic search functionality. It's perfect for individuals who want to explore how Tribora can help capture and organize their knowledge before committing to a paid plan.",
  },
  {
    id: 'faq-2',
    question: 'How does the 14-day free trial work?',
    answer:
      'When you sign up for Pro, you get full access to all Pro features for 14 days with no credit card required. At the end of the trial, you can choose to subscribe or continue with the free plan. All your recordings and data will be preserved either way.',
  },
  {
    id: 'faq-3',
    question: 'Can I upgrade or downgrade at any time?',
    answer:
      'Yes! You can upgrade your plan at any time, and the new features will be available immediately. If you downgrade, the change will take effect at the end of your current billing period. Your data is always safe and accessible regardless of plan changes.',
  },
  {
    id: 'faq-4',
    question: 'What payment methods do you accept?',
    answer:
      'We accept all major credit cards (Visa, Mastercard, American Express) and can also accommodate invoicing for Enterprise customers. All payments are processed securely through Stripe with bank-level encryption.',
  },
  {
    id: 'faq-5',
    question: 'Is my data secure?',
    answer:
      'Absolutely. All data is encrypted at rest (AES-256) and in transit (TLS 1.3). We comply with SOC 2 Type II standards and are GDPR ready. Enterprise customers can also opt for on-premise deployment for complete data sovereignty.',
  },
  {
    id: 'faq-6',
    question: 'What integrations are available?',
    answer:
      "Tribora integrates with Google Drive, Microsoft SharePoint, OneDrive, Notion, and more. Our unique bidirectional sync allows you to publish enriched content back to your connected services—we're not just another silo.",
  },
  {
    id: 'faq-7',
    question: 'Do you offer discounts for nonprofits or education?',
    answer:
      'Yes! We offer 50% off for qualifying nonprofits, educational institutions, and open source projects. Contact our sales team with proof of status to learn more about our discount programs.',
  },
];
...
export default function PricingPage() {
  return usePricingPageImplementation();
}

function usePricingPageImplementation() {
    ...
    <div className="relative overflow-hidden">
        ...
        <div className="container px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.h1
              ...
              variants={fadeInUp}
            >
              Choose your <span className=" text-primary">knowledge plan</span>
            </motion.h1>
                  ...
                  <div className="relative z-10 p-6 sm:p-8">
                    ...
                    <ul className="mt-8 space-y-3">
                      {tier.features.map((feature, featureIndex) => (
                        ...
                        >
                          <div
                            className="shrink-0 mt-0.5 size-5 rounded-full
      ...
      <section className="relative py-20 sm:py-28 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          />
          <div
            className="absolute bottom-[30%] right-[5%] size-[500px] rounded-full
          ...
          >
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
              <p className="text-sm text-muted-foreground text-center sm:text-left">
                Tribora integrates with your existing tools. Connect Google
                Drive, SharePoint, Notion, and more.
              </p>
              <Link href="/sign-up">
      ...
      <section className="relative py-20 sm:py-28 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div
            className="absolute top-[20%] left-[10%] size-[400px] rounded-full
          ...
          >
            ...
            >
              ...
              <Link href="/contact">
                <Button
                  variant="outline"
                  className="rounded-full px-6 border-accent/30 hover:border-accent/50 hover:bg-accent/5 transition-all duration-300"
                >
                  Contact Support
                </Button>
              </Link>
