  ...
  return (
    <section className="relative pt-24 pb-16 sm:pt-32 sm:pb-20 lg:pt-40 lg:pb-24 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        />
        <div
          className="absolute bottom-[20%] left-[5%] size-[500px] rounded-full
      ...
      <div className="container px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className=" text-primary">capture knowledge</span>
          </motion.h1>
...
function FeatureHighlights() {
  return useFeatureHighlightsImplementation();
}

function useFeatureHighlightsImplementation() {
  return (
    <section className="relative py-16 sm:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        />
        <div
          className="absolute bottom-[20%] right-[10%] size-[400px] rounded-full
      ...
      <div className="container px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Six core capabilities that transform how teams capture and share
            knowledge.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="absolute right-6 top-6 z-10">
              <div className="flex size-12 items-center justify-center rounded-2xl bg-accent/20 backdrop-blur-sm border border-accent/30 transition-all duration-300 group-hover:scale-110 group-hover:bg-accent/30">
                <HugeiconsIcon
                  icon={Mic01Icon}
                  size={24}
                ...
                <div className="flex h-full flex-col justify-end">
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="flex size-10 items-center justify-center rounded-xl bg-accent/20 transition-all duration-300 group-hover:scale-110 group-hover:bg-accent/30">
                        <HugeiconsIcon
                          icon={MessageMultiple01Icon}
                          size={20}
                          className="text-accent"
                      ...
                      <Badge
                        variant="outline"
                        className="bg-accent/10 border-accent/30 text-accent text-xs"
                      >
                        <HugeiconsIcon
                          icon={SparklesIcon}
                          size={12}
                    ...
                    <Button
                      asChild
                      className="rounded-full bg-gradient-to-r from-accent to-secondary text-accent-foreground hover:shadow-[0_0_30px_rgba(0,223,130,0.4)] transition-all duration-300"
                    >
          ...
          >
            <Card className="h-full rounded-3xl border-border/50 bg-card/50 backdrop-blur-sm md:h-[300px] group hover:border-accent/30 hover:shadow-[0_0_40px_rgba(0,223,130,0.1)] transition-all duration-500">
              <CardContent className="flex h-full flex-col justify-center p-4 md:p-5">
                <div className="mb-3">
                  <span className="text-4xl font-bold md:text-3xl lg:text-6xl text-primary">
                    50
                  </span>
                ...
                <div className="flex -gap-x-2">
                  {[
                    { id: 'language-en', image: 21, fallback: 'EN' },
                    { id: 'language-es', image: 22, fallback: 'ES' },
                    { id: 'language-fr', image: 23, fallback: 'FR' },
                    { id: 'language-de', image: 24, fallback: 'DE' },
                    { id: 'language-jp', image: 25, fallback: 'JP' },
                  ].map((avatar) => (
                    <Avatar
                      key={avatar.id}
                      className="border-background size-8 border-2 md:size-8 lg:size-10 ring-2 ring-accent/20"
                    >
                      <AvatarImage
                        src={`https://i.pravatar.cc/100?img=${avatar.image}`}
                      />
          ...
          >
            <Card className="h-full relative overflow-hidden rounded-3xl border-border/50 md:h-[300px] group">
              ...
              <div className="absolute bottom-6 left-6 z-10">
                <div className="flex items-center gap-2 mb-2">
                  <div className="flex size-8 items-center justify-center rounded-lg bg-secondary/20 backdrop-blur-sm">
                    <HugeiconsIcon
                      icon={AiSearchIcon}
                      size={16}
              ...
              <div className="absolute inset-0 z-10 flex items-center justify-start p-4 md:p-6">
                <div>
                  <div className="mb-3 flex items-center gap-2 md:gap-3">
                    <div className="flex size-8 items-center justify-center rounded-xl bg-accent/20 backdrop-blur-sm md:size-10 transition-all duration-300 group-hover:scale-110">
                      <HugeiconsIcon
                        icon={AiNetworkIcon}
                        size={20}
                        className="text-accent"
          ...
          >
            <Card className="h-full rounded-3xl border-border/50 bg-card/50 backdrop-blur-sm md:h-[200px] group hover:border-accent/30 hover:shadow-[0_0_40px_rgba(0,223,130,0.1)] transition-all duration-500">
              <CardContent className="flex h-full flex-row items-center gap-6 p-4 md:p-6">
                <div className="flex size-14 shrink-0 items-center justify-center rounded-2xl bg-accent/20">
                  <HugeiconsIcon
                    icon={Clock01Icon}
                    size={28}
                    className="text-accent"
          ...
          >
            <Card className="h-full rounded-3xl border-border/50 bg-card/50 backdrop-blur-sm md:h-[200px] group hover:border-secondary/30 hover:shadow-[0_0_40px_rgba(44,194,149,0.1)] transition-all duration-500">
              <CardContent className="flex h-full flex-row items-center gap-6 p-4 md:p-6">
                <div className="flex size-14 shrink-0 items-center justify-center rounded-2xl bg-secondary/20 transition-all duration-300 group-hover:scale-110 group-hover:bg-secondary/30">
                  <HugeiconsIcon
                    icon={File01Icon}
                    size={28}
                    className="text-secondary"
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Recordings transform into structured, searchable docs
                    instantly
                  </p>
                </div>
              </CardContent>
      ...
      <div className="container px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.h2
            ...
            variants={itemVariants}
          >
            Explore every <span className=" text-primary">capability</span>
          </motion.h2>
          <motion.p
            className="text-lg text-muted-foreground font-light"
            variants={itemVariants}
          >
            Detailed look at how each feature helps you capture and leverage
            knowledge.
          </motion.p>
        </motion.div>
                  ...
                  <ul className="space-y-3 mb-8">
                    {feature.bullets.map((bullet) => (
                      <li key={bullet} className="flex items-start gap-3">
                        <div
                          className={cn(
                            'shrink-0 mt-1 size-5 rounded-full',
                            'bg-accent/10',
                            'flex items-center justify-center',
                          )}
                        >
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center p-8">
                        <div
                          className={cn(
                            'size-20 rounded-2xl mx-auto mb-4',
                            'bg-accent/20',
                            'flex items-center justify-center',
                            'transition-all duration-500',
      ...
      <div className="container px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.h2
            ...
            variants={itemVariants}
          >
            How Tribora <span className=" text-primary">compares</span>
          </motion.h2>
          <motion.p
            className="text-lg text-muted-foreground font-light"
            variants={itemVariants}
                        ...
                        {typeof row.tribora === 'boolean' ? (
                          row.tribora ? (
                            <div className="flex justify-center">
                              <div
                                className="size-6 rounded-full bg-accent/20
                                  flex items-center justify-center"
                              >
                                <HugeiconsIcon
                                  icon={Tick02Icon}
