  ...
  return (
    <section className="relative py-16 sm:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute top-[20%] right-[10%] size-[400px] rounded-full
            bg-[radial-gradient(ellipse_at_center,rgba(0,223,130,0.08)_0%,transparent_70%)]
            blur-[80px] animate-float"
        />
        <div
          className="absolute bottom-[20%] left-[10%] size-[350px] rounded-full
      ...
      <div className="container px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            >
              <Layers className="size-4 mr-2 text-accent" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            {data.items.map((item, index) => (
              <motion.div key={JSON.stringify(item)} variants={itemVariants}>
                <Card
                  className={cn(
                    'h-full rounded-2xl',
                ...
                >
                  <CardContent className="p-6 sm:p-8 h-full flex flex-col">
                    {/* Icon */}
                    <div
                      className="shrink-0 size-12 rounded-xl mb-4
                          bg-accent/10
