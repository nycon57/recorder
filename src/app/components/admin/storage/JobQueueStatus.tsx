...
export default function JobQueueStatus() {
  const { data, isLoading, error } = useQuery<JobQueueData, Error>({
    queryKey: ['analytics', 'metrics', 'job-queue'],
      ...
      <Card className="border-destructive">
        <CardContent className="pt-6">
          <p className="text-sm text-destructive">
            Error loading job queue data: {error.message}
          </p>
        </CardContent>
      </Card>
    );
    ...
    <div className="space-y-6">
              ...
              <div key={jobType.type} className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant={
                        jobType.successRate >= 95
                          ? 'default'
                          : jobType.successRate >= 80
                            ? 'secondary'
                            : 'destructive'
                      }
                      className="text-xs"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Queue health and efficiency metrics</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-3 gap-6">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                {data.stats.pending} pending + {data.stats.processing}{' '}
                processing
              </p>
            </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-yellow-700 dark:text-yellow-300 mt-1">
                    The job queue is experiencing high load. Consider scaling up
