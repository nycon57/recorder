              ...
              {CONCEPT_TYPES.map((type) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && (
                      <Check className="size-4 text-primary flex-shrink-0" aria-hidden="true" />
                    )}
                  </button>
                );
              })}
            ...
            {CONCEPT_TYPES.map((type) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'flex items-center gap-2 w-full px-2 py-1 text-xs rounded hover:bg-zinc-50',
                ...
                >
                  ...
                  {isSelected && <Check className="size-3 text-purple-500" />}
                </button>
              );
            })}
          </div>
