 ...
 *
 * GET /api/connectors/auth/notion - Handle Notion OAuth callback
 */
...
/**
 * GET /api/connectors/auth/notion
  ...
  try {
    ...
    const tokenResponse = await fetch('https://api.notion.com/v1/oauth/token', {
      ...
      body: JSON.stringify({
        ...
        redirect_uri: `${process.env.NEXT_PUBLIC_APP_URL}/api/connectors/auth/notion`,
      }),
    });
