...
export function DepartmentFormModal({
  ...
  useEffect(() => {
    if (department) {
      const allowedVisibilities = ['private', 'department', 'org', 'public'];
      const visibility = allowedVisibilities.includes(department.default_visibility)
        ? (department.default_visibility as 'private' | 'department' | 'org' | 'public')
        : 'department';
